...
public class EndDogFoodEatenProcedure extends DimensionalCornDogModElements.ModElement {
	public EndDogFoodEatenProcedure(DimensionalCornDogModElements instance) {
		super(instance, 8);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure EndDogFoodEaten!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure EndDogFoodEaten!");
			return;
		}
