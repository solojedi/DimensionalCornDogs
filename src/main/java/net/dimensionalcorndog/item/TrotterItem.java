...
public class TrotterItem extends DimensionalCornDogModElements.ModElement {
	@ObjectHolder("dimensional_corn_dog:trotter")
	public static final Item block = null;
	public TrotterItem(DimensionalCornDogModElements instance) {
		super(instance, 3);
	}
