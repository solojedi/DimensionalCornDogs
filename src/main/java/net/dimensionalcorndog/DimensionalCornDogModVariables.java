...
public class DimensionalCornDogModVariables {
	...
	public void onPlayerLoggedIn(PlayerEvent.PlayerLoggedInEvent event) {
		if (!event.getPlayer().world.isRemote) {
			...
			if (mapdata != null)
				DimensionalCornDogMod.PACKET_HANDLER.send(PacketDistributor.PLAYER.with(() -> (ServerPlayerEntity) event.getPlayer()),
	...
	public static class WorldVariables extends WorldSavedData {
		public static final String DATA_NAME = "dimensional_corn_dog_worldvars";
		...
		public void syncData(IWorld world) {
			...
			if (!world.getWorld().isRemote)
				DimensionalCornDogMod.PACKET_HANDLER.send(PacketDistributor.DIMENSION.with(world.getWorld().dimension::getType),
	...
	public static class MapVariables extends WorldSavedData {
		public static final String DATA_NAME = "dimensional_corn_dog_mapvars";
		...
		@Override
		public void read(CompoundNBT nbt) {
			JustTeleported = nbt.getBoolean("JustTeleported");
		}

		@Override
		public CompoundNBT write(CompoundNBT nbt) {
			nbt.putBoolean("JustTeleported", JustTeleported);
			return nbt;
		}
		...
		public void syncData(IWorld world) {
			this.markDirty();
			if (!world.getWorld().isRemote)
				DimensionalCornDogMod.PACKET_HANDLER.send(PacketDistributor.ALL.noArg(), new WorldSavedDataSyncMessage(0, this));
		}
